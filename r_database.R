...
#
#Script Description: Familiar with reticulate and rdataretriever packages, as well as PostgreSQL and SQLite
# illustrating how to upload the data of Doubs, a built-in dataset of ade4 package into a schema of PostgreSQL or the SQLite.
#
#
#SETUP ----------------------------------------------
